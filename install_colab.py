...
run_cmd('apt-get update -qq && apt-get install -y ffmpeg -qq', "Installing FFmpeg")

# Step 2: Fix NumPy (CRITICAL for OpenCV compatibility)
run_cmd('pip uninstall -y numpy', "Uninstalling incompatible NumPy")
run_cmd('pip install "numpy<2.0"', "Installing NumPy 1.x")

# Step 3: Install Python dependencies
run_cmd('pip install -r requirements.txt', "Installing Python dependencies")

# Step 4: Fix basicsr import error (CRITICAL!)
print("\n📦 Patching basicsr for torchvision compatibility...")
try:
    import site
